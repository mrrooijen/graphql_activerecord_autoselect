...
class GraphQLActiveRecordAutoSelectTest < ActiveSupport::TestCase
  ...
  Lookahead  = Struct.new(:selections) do
    def selection(_); self end
    def selects?(_); false end
  end
  ...
  test "ActiveRecord::Base integration" do
    ...
    query = %Q{SELECT "b_models"."id", "b_models"."type", "b_models"."parent_id", } +
            %Q{"b_models"."parent_type", "b_models"."first_name", "b_models"."last_name" FROM "b_models"}
  ...
  test "ActiveRecord::Relation integration" do
    ...
    b     = BModel.create
    query = %Q{SELECT "d_models"."id", "d_models"."b_model_id", "d_models"."first_name", } +
            %Q{"d_models"."last_name" FROM "d_models" WHERE "d_models"."b_model_id" = #{b.id}}
